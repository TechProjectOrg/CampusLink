...
## Corpus Check
- 167 files · ~157,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1157 nodes · 1833 edges · 41 communities detected
...
Cohesion: 0.14
Nodes (19): handleLogin(), handleLogout(), handlePopState(), load(), openClubDrawer(), openUserDrawer(), parsePageFromPath(), refreshCurrentPage() (+11 more)
...
- **Thin community `Community 43`** (5 nodes): `Carousel()`, `CarouselNext()`, `cn()`, `useCarousel()`, `carousel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (5 nodes): `clearStoredSession()`, `getAuthToken()`, `readStoredSession()`, `writeStoredSession()`, `authStorage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `apiCreateUserPost()` connect `Community 14` to `Community 0`, `Community 8`, `Community 17`, `Community 1`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `handleAddProject()` connect `Community 17` to `Community 1`, `Community 2`, `Community 14`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `fetchCachedValue()` connect `Community 1` to `Community 8`, `Community 17`, `Community 3`?**
