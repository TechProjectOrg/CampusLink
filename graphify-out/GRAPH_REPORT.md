...
## Corpus Check
- 186 files · ~229,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1445 nodes · 2332 edges · 45 communities detected
...
Cohesion: 0.06
Nodes (42): canAccessUserContent(), canMessage(), getBlockState(), getBlockStates(), getProfileVisibility(), getProfileVisibilityFromState(), isBlockedEitherWay(), maskUserCardForViewer() (+34 more)
...
- **Why does `cacheDelete()` connect `Community 0` to `Community 8`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `handlePasswordChange()` connect `Community 9` to `Community 4`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `apiCreateUserPost()` connect `Community 13` to `Community 2`, `Community 3`, `Community 12`?**
