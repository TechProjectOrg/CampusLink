# Graph Report - final-year-project  (2026-05-12)

## Corpus Check
- 161 files · ~148,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1117 nodes · 1769 edges · 39 communities detected
...
- **Thin community `Community 41`** (5 nodes): `Carousel()`, `CarouselNext()`, `cn()`, `useCarousel()`, `carousel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (5 nodes): `clearStoredSession()`, `getAuthToken()`, `readStoredSession()`, `writeStoredSession()`, `authStorage.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `handleAddProject()` connect `Community 17` to `Community 1`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `apiCreateUserPost()` connect `Community 13` to `Community 0`, `Community 17`, `Community 2`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Alert()` connect `Community 1` to `Community 17`?**
