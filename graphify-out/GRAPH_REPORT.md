...
## Corpus Check
- 168 files · ~194,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1327 nodes · 2129 edges · 39 communities detected
...
1. `safeFetch()` - 23 edges
2. `cacheSetJson()` - 22 edges
...
Cohesion: 0.04
Nodes (79): getCounterValue(), incrementCounter(), cacheGetJson(), cacheHashGet(), cacheHashIncrementBy(), cacheHashMultiGet(), cacheHashSet(), cacheHGetAll() (+71 more)
...
Cohesion: 0.05
Nodes (69): appendStreamMessage(), areRedisStreamsEnabled(), cacheExpire(), cacheHashDelete(), cacheIncrement(), cacheSetAdd(), cacheSetCardinality(), cacheSetJson() (+61 more)
...
Cohesion: 0.04
Nodes (42): buildAuthenticatedResponse(), buildMagicLinkRedirect(), buildOnboardingResponse(), buildUsernameSuggestion(), createAlumniUser(), createAuthSession(), createDefaultUserSettings(), createStudentUser() (+34 more)
...
Cohesion: 0.11
Nodes (36): handlePasswordChange(), apiAuthenticateWithGoogle(), apiChangePassword(), apiCheckUsernameAvailability(), apiCompleteGoogleOnboarding(), apiCompleteMagicLinkOnboarding(), apiCompleteStudentSignup(), apiDeleteAccount() (+28 more)
...
- **Why does `handleAddProject()` connect `Community 1` to `Community 6`, `Community 14`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `apiCreateUserPost()` connect `Community 14` to `Community 1`, `Community 3`?**
