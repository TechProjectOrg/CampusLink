...
## Corpus Check
- 167 files · ~168,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1190 nodes · 1890 edges · 38 communities detected
...
Cohesion: 0.03
Nodes (93): appendStreamMessage(), areRedisStreamsEnabled(), cacheExpire(), cacheGetJson(), cacheHashDelete(), cacheHashGet(), cacheHashIncrementBy(), cacheHashMultiGet() (+85 more)
...
Cohesion: 0.07
Nodes (36): async(), buildClubsQueryString(), buildQueryString(), buildUsersQueryString(), dashboardMetricTarget(), fetchAdminPageData(), getAdminQueryKey(), getAdminUserDetailQueryKey() (+28 more)
...
Cohesion: 0.13
Nodes (32): invalidateAdminClubCaches(), cacheDelete(), cacheSetJsonIfNotExists(), invalidateConversationLists(), acquireCacheLock(), buildEnvelope(), buildPermissionSnapshot(), cacheLockKey() (+24 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (29): cacheSetJson(), cacheZAddMany(), cacheZRem(), cacheZRevRange(), engagementKey(), feedKey(), feedWarmedKey(), fetchFeedIdRowsFromDb() (+21 more)
...
Cohesion: 0.14
Nodes (22): cacheSetAdd(), cacheSetCardinality(), cacheSetMembers(), applyDiversity(), dismissedKey(), dismissSuggestedUser(), getSuggestedUsersForApi(), getTrendingHashtagsForApi() (+14 more)
...
- **Thin community `Community 26`** (7 nodes): `getAdminAccountByUserId()`, `markAdminLogin()`, `recordAdminAuditLog()`, `setAdminMustChangePassword()`, `admin.ts`, `requireAdmin.ts`, `requireAdmin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (5 nodes): `Carousel()`, `CarouselNext()`, `cn()`, `useCarousel()`, `carousel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (3 nodes): `NetworkPage.tsx`, `mutualFollowersCount()`, `uniqueIntersection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `apiCreateUserPost()` connect `Community 13` to `Community 8`, `Community 1`, `Community 2`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `persistCreatedPost()` connect `Community 2` to `Community 13`?**
