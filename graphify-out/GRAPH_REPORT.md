...
## Corpus Check
- 190 files · ~268,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1525 nodes · 2465 edges · 43 communities detected
...
Cohesion: 0.05
Nodes (71): appendStreamMessage(), areRedisStreamsEnabled(), cacheExpire(), cacheHashDelete(), cacheHashSet(), cacheHGetAll(), cacheIncrement(), cacheSetAdd() (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (57): apiCreateUserCertification(), apiDeleteUserCertification(), apiFetchUserCertifications(), apiUpdateUserCertification(), authHeaders(), parseErrorMessage(), apiCreateUserExperience(), apiDeleteUserExperience() (+49 more)
...
Cohesion: 0.05
Nodes (62): getCounterValue(), incrementCounter(), getBlockStates(), cacheGetJson(), cacheHashGet(), cacheHashIncrementBy(), cacheHashMultiGet(), parseJson() (+54 more)
...
Cohesion: 0.07
Nodes (40): areUsersMutuallyFollowing(), emitChatDelete(), emitChatMessage(), emitChatReaction(), emitChatRead(), emitChatRequestAccepted(), emitTypingIndicator(), getOrCreateDirectChat() (+32 more)
...
Cohesion: 0.09
Nodes (14): handleEventSubmit(), handleOpportunitySubmit(), handlePostSubmit(), resetAllForms(), collectImageFiles(), resolvePostImageUrls(), resolveProjectImageUrls(), withOpportunityImages() (+6 more)
...
- **Thin community `Community 31`** (7 nodes): `Navbar.tsx`, `handleMobileSearchChange()`, `handleMobileSearchToggle()`, `handleSearchChange()`, `handleSearchFocus()`, `handleTabletSearchToggle()`, `handleTabNavigate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (5 nodes): `NetworkPage.tsx`, `fallbackStudentFromNetworkUser()`, `prioritizeNetworkUsers()`, `renderViewerFollowAction()`, `resolveStudent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `cacheDelete()` connect `Community 12` to `Community 1`, `Community 10`, `Community 4`, `Community 9`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `handlePasswordChange()` connect `Community 5` to `Community 7`?**
