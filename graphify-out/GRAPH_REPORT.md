...
## Corpus Check
- 170 files · ~217,653 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1382 nodes · 2235 edges · 43 communities detected
...
5. `writeCacheEntry()` - 17 edges
6. `authHeaders()` - 17 edges
7. `parseErrorMessage()` - 17 edges
...
Cohesion: 0.06
Nodes (59): getCounterValue(), cacheGetJson(), cacheHashGet(), cacheHashMultiGet(), cacheHashSet(), parseJson(), autoAcceptRequestOnReply(), buildConversationListEntries() (+51 more)
...
Cohesion: 0.06
Nodes (40): buildAuthenticatedResponse(), getJwtSecret(), signAuthToken(), signPasswordChangeToken(), signPasswordResetToken(), signVerificationActionToken(), verifyAuthToken(), verifyPasswordChangeToken() (+32 more)
...
- **Why does `apiCreateUserPost()` connect `Community 15` to `Community 0`, `Community 2`, `Community 12`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `cacheSetJson()` connect `Community 1` to `Community 3`, `Community 4`, `Community 8`, `Community 13`, `Community 14`?**
