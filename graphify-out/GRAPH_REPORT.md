...
## Corpus Check
- 161 files · ~142,692 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1101 nodes · 1740 edges · 37 communities detected
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 257 edges (avg confidence: 0.8)
...
Cohesion: 0.05
Nodes (59): apiCreateUserAchievement(), apiDeleteUserAchievement(), apiFetchUserAchievements(), apiUpdateUserAchievement(), authHeaders(), parseErrorMessage(), apiCreateUserCertification(), apiDeleteUserCertification() (+51 more)
...
Cohesion: 0.06
Nodes (47): handleMarkAllAsRead(), compareVersions(), createCacheEntry(), createPageEntry(), enforcePolicyLimit(), estimateByteSize(), incrementCacheRevalidations(), invalidateCache() (+39 more)
