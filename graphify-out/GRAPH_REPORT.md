...
Cohesion: 0.11
Nodes (23): areUsersMutuallyFollowing(), emitChatDelete(), emitChatMessage(), emitChatReaction(), emitChatRead(), emitChatRequestAccepted(), emitTypingIndicator(), getChatParticipantIds() (+15 more)
...
- **Why does `apiCreateUserPost()` connect `Community 8` to `Community 0`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `persistCreatedPost()` connect `Community 0` to `Community 8`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `apiFetchProfilePosts()` connect `Community 8` to `Community 3`?**
