...
## Corpus Check
- 190 files · ~280,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1519 nodes · 2448 edges · 43 communities detected
...
Cohesion: 0.03
Nodes (100): getCounterValue(), incrementCounter(), getBlockStates(), maskUserCardForViewer(), appendStreamMessage(), areRedisStreamsEnabled(), cacheExpire(), cacheGetJson() (+92 more)
...
Cohesion: 0.08
Nodes (49): cacheSetAdd(), cacheSetCardinality(), cacheSetJson(), cacheSetMembers(), engagementKey(), feedKey(), feedWarmedKey(), fetchFeedIdRowsFromDb() (+41 more)
...
- **Why does `cacheDelete()` connect `Community 12` to `Community 0`, `Community 8`, `Community 9`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `handlePasswordChange()` connect `Community 4` to `Community 5`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `cacheSetJson()` connect `Community 8` to `Community 0`, `Community 1`, `Community 12`, `Community 6`?**
