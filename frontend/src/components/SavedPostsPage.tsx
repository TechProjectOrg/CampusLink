...
export function SavedPostsPage({
  ...
  return (
    <PageLayout maxWidth="7xl" className="bg-slate-50 pb-24 md:pb-8" contentClassName="py-4 sm:py-5 lg:py-6">
      <div className="cl-saved-posts-page-stack mx-auto w-full space-y-6" style={{ maxWidth: '1000px' }}>
        <header className="cl-profile-subpage-header cl-saved-posts-header overflow-visible rounded-3xl border border-slate-200/80 bg-white px-6 pb-6 pt-4 shadow-sm sm:px-7 sm:pb-7 sm:pt-5">
          ...
          <div className="cl-profile-subpage-hero mt-2 flex items-center gap-4 pl-1 sm:gap-5">
            ...
            <div className="cl-profile-subpage-copy space-y-1">
              <p className="cl-profile-subpage-kicker text-sm font-medium uppercase tracking-[0.18em] text-slate-400">Saved Posts</p>
              <h1 className="cl-profile-subpage-title text-2xl font-semibold tracking-tight text-slate-950">{student.name}</h1>
              <p className="cl-profile-subpage-blurb mt-1 text-sm text-slate-500">Private collection of posts you saved for later.</p>
            </div>
          </div>
        </header>
        ...
        {isLoading ? (
          ...
          <div className="cl-saved-posts-empty rounded-3xl border border-slate-200/80 bg-white p-10 text-center shadow-sm">
            <Bookmark className="cl-saved-posts-empty-icon mx-auto h-10 w-10 text-blue-300" />
            <p className="cl-saved-posts-empty-copy mt-4 font-medium text-slate-700">Save posts you want to revisit later.</p>
          </div>
        )}
      </div>
    </PageLayout>
